...
public class PlayerWeaponsManager : MonoBehaviour
{
    ...
    public bool PaidForReload = false;
    ...
    void Start()
    {
        ...
        InGameMenuManager.OnPaymentSuccessful += HandleOnPaymentSuccessful;
    }
    
    private void HandleOnPaymentSuccessful()
    {
        PaidForReload = true;
    }
    ...
    void Update()
    {
        ...
        {
            if (!activeWeapon.AutomaticReload && PaidForReload && activeWeapon.CurrentAmmoRatio < 1.0f)
            {
                IsAiming = false;
                PaidForReload = false;
